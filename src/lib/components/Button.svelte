...
<button 
  class="p-2 rounded-full select-none active:rounded-xl font-medium transition-all duration-300 active:brightness-90 flex items-center justify-center gap-2 {variantClass} {className}"
  {...rest}
>
  {@render children?.()}
</button>
